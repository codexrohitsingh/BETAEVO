...
export function PromotionalBanner() {
  return (
    <section className="container-custom py-12">
      <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-r from-[#FDFBF7] to-[#EAE6DD] px-8 py-12 md:px-16 md:py-20 shadow-sm">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          {/* Content Side */}
          <div className="space-y-8 relative z-10">
            <h2 className="text-4xl font-bold leading-tight tracking-tight text-brand-black md:text-5xl lg:text-6xl">
              <span className="text-brand-copper">Upgrade</span> Together.<br />
              <span className="text-brand-copper">Save</span> Bigger.
            </h2>
            
            <div className="inline-flex flex-wrap items-center gap-6 rounded-2xl border-2 border-dashed border-brand-copper/30 bg-white/50 p-4 backdrop-blur-sm">
              <div className="flex flex-col border-r border-brand-copper/30 pr-6">
